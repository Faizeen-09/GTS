...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Give Your Feedback</h1>
                <div class="row g-4">
                    <!-- <div class="col-12">
                        <div class="row gy-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            <textarea class="form-control" name="feedback" required minlength="8" maxlength="100" id="message" style="height: 150px"></textarea>
